    ...
    <form onSubmit={formik.handleSubmit} className="flex flex-col gap-3">
      {Object.keys(formik.values).map((i) => (
        <InputWithValidation
          ...
          placeholder={i !== 'confirm password' ? `Enter ${i}` : i}
      ...
      <button
        className="w-full h-10 px-4 py-2 text-sm font-medium text-white transition-all duration-150 border border-transparent rounded-md shadow-sm bg-[#082373] focus:outline-none hover:bg-[#082373]-700 hover:ease-in"
        type="submit"
